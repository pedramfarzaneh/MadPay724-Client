(function ($) {
	...
	setTimeout(function () {
		new Noty({
		    text: '<div class="text-center">منتظر باشید! الیسام کامل بارگذاری شود.</div>',
		    type: 'notification',
		    layout: 'topRight',
		    timeout: 3000,
			animation: {
    ...
    var firstPopup = "وحید پرواز <span class='badge-text badge-text-small info ml-2'>پرداخت شده</span>";
    var secondPopup = "وحید پرواز <span class='badge-text badge-text-small danger ml-2'>کنسل شده</span>";
    var thirdPopup = "وحید پرواز <span class='badge-text badge-text-small info ml-2'>پرداخت شده</span>";
